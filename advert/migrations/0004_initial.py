# Generated by Django 4.2.9 on 2024-02-18 15:41
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ...
        ('advert', '0003_remove_formpage_page_ptr_delete_formfield_and_more'),
    ]
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('extra_info', wagtail.fields.StreamField([('Block', wagtail.blocks.StructBlock([('label', wagtail.blocks.CharBlock()), ('description', wagtail.blocks.CharBlock())]))], blank=True, use_json_field=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('page', modelcluster.fields.ParentalKey(on_delete=django.db.models.deletion.CASCADE, related_name='form_fields', to='advert.formpage')),
            ],
            options={
                'ordering': ['sort_order'],
                'abstract': False,
